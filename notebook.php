    ...
    <div class="modal-content">
        ...
        <form id="editNoteForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="editTitle" name="title" readonly style="padding: 10px 10px">
            </div>
            <div class="form-group">
    ...
    <div class="modal-content">
        ...
        <form action="addnotes.php" method="POST">
            ...
            <div class="form-group">
                ...
                <textarea id="content" name="content" class="form-control form-control-textarea" rows="10" cols="50" required></textarea><br><br>
            </div>
